                                ...
                                <div class="col-lg-8 mt-5 mt-lg-0">
                                    ...
                                    <form action="feedback" method="post">
                                            ...
                                            <c:choose>
                                                <c:when test="${user != null}">
                                                    ...
                                                    <c:if test="${user.user_gender == false}">
                                                        ...
                                                        <input checked name="gender" checked="checked" type="radio"
                                                            value="0"> Female
                                                    </c:if>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <div class="form-group mt-3">
                                            <input type="tel" pattern="[0-9\-\+]{9,15}" type="text" class="form-control"
                                                name="phone" value="${user.user_phone}" id="subject" placeholder="Phone"
                                                required>
                                        </div>

                                        <div class="form-group mt-3">
                                            <textarea class="form-control" name="note" rows="5" placeholder="Feedback"
                                                required></textarea>
                                        </div>
                                        <div class="form-group mt-3">
                                            <select name="star">
                                        ...
                                        <div class="col-md-12">
                                            <label class="labels">
                                                UPLOAD IMAGE<img class="o rounded-circle mt-5" width="100px"
                                                    height="100px"
                                                ...
                                                <input accept="image/*" hidden="hidden" name="image" type="file"
