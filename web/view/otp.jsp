                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body p-5">
                                ...
                                <h1 class="fs-4 card-title fw-bold mb-4">XÁC MINH TÀI KHOẢN</h1>
                                <form action="otp" method="POST" class="needs-validation">
                                    <div class="mb-3">

                                        
                                        <label class="mb-2 text-muted" for="otp">Vui lòng nhập mã OTP:</label>
