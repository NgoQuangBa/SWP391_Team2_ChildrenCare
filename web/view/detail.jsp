                ...
                <div class="page-title-inner flex-row medium-flex-wrap container">
                    <div class="flex-col flex-grow medium-text-center">
                        <div class="is-smaller">
                            <nav class="woocommerce-breadcrumb breadcrumbs uppercase"><a href="home">Trang chủ</a> <span class="divider">&#47;</span> <a href="filter-category?cid=${c.categoryID}">${c.categoryName}</a></nav></div>
                    </div>
                        ...
                        <div class="product-container">
                            <div class="product-main">
                                <div class="row content-row mb-0">
                                    ...
                                    <div class="product-info summary col-fit col entry-summary product-summary text-left form-flat">
                                        ...
                                        <a  class="button alt" style=" background-color: #0a4da8" href="add-to-cart?sid=${s.serviceID}">Đặt lịch khám</a>
                                        <a href="SendFeedback?sid=${param['sid']}" style="" class="button alt">Send Feedback</a>
                            ...
                            <div class="product-footer">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <diV class="col-2"></diV>
                                        <div class="display-feedback col-8">
                                            <h2 style="padding: 10px;  margin: 20px;text-align: center;">Feed Back list </h2>
                                            <c:forEach items="${fblist}" var="fb">
                                                <div class="feedback-item" style="height: 180px;">
                                                    <div class="fb-content">
                                                        <div class="avatar">Customer id ${fb.getCustomerID()} - ${fb.getRated()}<i class="fa-solid fa-star" style="color: red;"></i></span></div>
                                                        <p> Feedback Date: ${fb.getCreateDate()}</p>
                                                        <span class="description" style="width:70% "> Feedback content:: ${fb.getDetail()}</span>
                                                    </div>
                                                    <div class="fb-img"> 
                                                        <image src="${fb.getImglink()}"  width="150px">
                                                    </div>
                                                </div>
                                            </c:forEach>
