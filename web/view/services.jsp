                            ...
                            <div class="flex-col medium-text-center">
                                ...
                                <form class="woocommerce-ordering" method="get">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="services">Mặc định</a></li>
                                        <li><a class="dropdown-item" href="services?sort=des">Giá: Cao đến thấp</a></li>
                                        <li><a class="dropdown-item" href="services?sort=asc">Giá: Thấp tới cao</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row category-page-row">
                        ...
                        <div class="col large-3 hide-for-medium ">
                            <div id="shop-sidebar" class="sidebar-inner col-inner">
                                <aside id="woocommerce_price_filter-9" class="widget woocommerce widget_price_filter"><span class="widget-title shop-sidebar">Tìm kiếm</span><div class="is-divider small"></div>
<!--                                    <form method="get" action="https://shop.mixigaming.com/danh-muc/ao-mixi/">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="search" class="form-control" placeholder="Vui lòng nhập..." aria-label="Recipient's username" aria-describedby="button-addon2" name="keyword">
                                        <button class="btn btn-outline-secondary" type="submit" id="button-addon2"><i class="fa fa-search" style="color: white"></i></button>
                                    </div>
                                </form>

                                </aside><aside id="woocommerce_product_categories-13" class="widget woocommerce widget_product_categories"><span class="widget-title shop-sidebar">Danh mục dịch vụ</span><div class="is-divider small"></div><ul class="product-categories">
                                        <c:forEach  items="${listc}" var="c">
                                            <li class="cat-item cat-item-142"><a href="filter-category?cid=${c.categoryID}">${c.categoryName}</a></li>
                                            </c:forEach>
                                                ...
                                                <div class="product-small box ">
                                                    <div class="box-image">
                                                        <div class="image-fade_in_back">
                                                            <a href="detail?sid=${s.serviceID}">
                                                                <img width="300" height="400" src="${s.imageURL}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Apcitylogoden" loading="lazy" />		</a>
                                                        </div>
                                                    ...
                                                    <div class="box-text box-text-products text-center grid-style-2">
                                                        <div class="title-wrapper">	 	
                                                            <p class="name product-title woocommerce-loop-product__title"><a href="detail?sid=${s.serviceID}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link " style="font-weight: bold;font-size: initial">${s.serviceName}</a></p></div><div class="price-wrapper">
                                                            <span class="price"><span class="woocommerce-Price-amount amount" style="font-style: italic; display: block;margin-bottom: 5px;margin-top: 10px;">
                                                                    <bdi><fmt:formatNumber value="${s.servicePrice}" minFractionDigits="0" maxFractionDigits="0"/><span class="woocommerce-Price-currencySymbol">.000&#8363;</span></bdi>
                                                                                
                                                                </span></span>
                                                            <div><a  class="button alt" style=" background-color: #0a4da8" href="add-to-cart?sid=${s.serviceID}">Đặt lịch khám </a></div>
                                                        </div>		</div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <ul class="pagination " >
                        <li class="page-item ${page==1||page==null?"disabled":""}" ><a class="page-link " href="services?sort=${param['sort']}&page=${page-1}">Trang Trước</a></li>
                            <c:forEach begin="1" end="${totalPage}" var="i">
                            <li class="page-item ${page==i?"active":""}"><a class="page-link" href="services?sort=${param['sort']}&page=${i}">${i}</a></li>
                            </c:forEach>

                        <li class="page-item ${page==totalPage?"disabled":""}"><a class="page-link" href="services?sort=${param['sort']}&page=${page+1}">Trang Sau</a></li>
                    </ul>
                </nav>
            </main>
                    ...
                    <li class="header-search-form search-form html relative has-icon">
                        <div class="header-search-form-wrapper">
                            <div class="searchform-wrapper ux-search-box relative form-flat is-normal">
                                <form role="search" method="get" class="searchform" action="https://shop.mixigaming.com/">
