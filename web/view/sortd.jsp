                            ...
                            <div class="flex-col medium-text-center">
                                ...
                                <form class="woocommerce-ordering" method="get">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li ><a class="dropdown-item " href="services" >Tất cả</a></li>
                                        <li ><a class="dropdown-item " href="sort" >Giá: Thấp tới cao</a></li>
...
<!--                                    <form method="get" action="https://shop.mixigaming.com/danh-muc/ao-mixi/">
                    ...
                    <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                        <ul class="pagination " >
                            <li class="page-item ${page==1||page==null?"disabled":""}" ><a class="page-link " href="sortd?page=${page-1}">Trang Trước</a></li>
                                <c:forEach begin="1" end="${totalPage}" var="i">
                                <li class="page-item ${i==page?"active":""}"><a class="page-link" href="sortd?page=${i}">${i}</a></li>
                                </c:forEach>

                            <li class="page-item ${page==totalPage?"disabled":""}"><a class="page-link" href="sortd?page=${page+1}">Trang Sau</a></li>
                        </ul>
                    </nav>
            </main>
