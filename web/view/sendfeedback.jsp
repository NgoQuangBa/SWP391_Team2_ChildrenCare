            ...
            <main id="main" class="">
                ...
                <div id="content" role="main" class="content-area">
                    ...
                    <div class="row category-page-row">
                        ...
                        <div class="col large-9 hide-for-medium ">
                                ...
                                <div class="main-content">
                                    <form action="SendFeedback" method="post">
                                        <div class="product-info">
                                            ...
                                            <p><b>Tên: </b>${ser.serviceName}</p>
                                            <p><b>Giá: </b>${ser.servicePrice}k vnđ </p>
                                        </div>
                                        <span><b>Feedback content:</b></span>
                                        <textarea class="form-control" name="feedbackContent" id="feedbackContent" ></textarea>
                                        <span id="invalid" style="color: red; display: none;"> <i class="fa fa-exclamation" aria-hidden="true"></i> 
                                            Your feedback content must less than 500 character</span>
                                        ...
                                        <input type="file" id="fbimg" class="form-control" name="fbimg" onchange="changeFbimg()" accept=".jpg, .jpeg, .png"><br>
